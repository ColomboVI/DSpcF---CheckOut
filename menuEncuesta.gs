...
function crearFormulario() {
   ...
   if(pais == 'EEUU'){
    /************************************************************************************
    *                   Plantilla de formulario de DScpF                                * 
    * https://docs.google.com/forms/d/1TnXK4tQtDe3mUKx__o243P69jL53Ger8tpk-qJ3cikA/edit *
    *************************************************************************************/  
   var formulario = DriveApp.getFileById('1TnXK4tQtDe3mUKx__o243P69jL53Ger8tpk-qJ3cikA').makeCopy('Cuestionario Alumnos Data Specialist Fundamentals',DriveApp.getRootFolder()); 
...
//          new Comunicaciones().mandarfeedback(getEmailsEncuesta(), form)   
         ...
         /************************************************************************************
         *                   Plantilla de formulario de DScpF                                * 
         * https://docs.google.com/forms/d/1521k28vtw0yN3QGry_mvVMiKH0DRc35r28kPp-1EfR0/edit *
         *************************************************************************************/  
           var formulario = DriveApp.getFileById('1521k28vtw0yN3QGry_mvVMiKH0DRc35r28kPp-1EfR0').makeCopy('Cuestionario Alumnos Data Specialist Fundamentals',DriveApp.getRootFolder()); 
           var form = FormApp.openById(formulario.getId());  
           var carpeta = crearCarpeta()
           var formulario_drive= DriveApp.getFileById(form.getId()); 
          carpeta.addFile(formulario_drive);       
